<template>
  <div class="app-container">
    ...
    >
      <div id="pdfDom">
        <p class="tit" align="center">授权证书</p>
        <p class="proid">
          <span>编号:</span>
        ...
        <div class="con-unit">
          <p>区块链种质溯源系统</p>
          <p class="time">{{ formatDate(certificate.certifyTime) }}</p>
        </div>
        <p class=" con-footer">种质溯源系统 监制</p>
      </div>
      <span slot="footer" class="dialog-footer">
        <el-button @click="dialogCertifyVisible = false" type="primary">关闭</el-button>
        <el-button @click="getPdf('#pdf-Dom')" type="primary">点击下载</el-button>
      </span>
    </el-dialog>
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['CollectID', 'Type', 'Name', 'GermplasmName', 'GermplasmNameEn', 'SectionName', 'GenericName', 'ScientificName', 'ResourceType', 'CollectMethod', 'GermplasmSource', 'SourceCountry', 'SourceProvince', 'Source', 'SourceOrg', 'OriginCountry', 'OriginPlace', 'CollectPlaceLongitude', 'CollectPlaceLatitude', 'CollectPlaceAltitude', 'CollectPlaceSoilType', 'CollectPlaceEcologyType', 'CollectMaterialType', 'CollectPeople', 'CollectUnit', 'CollectTime', 'SpeciesName', 'Image', 'CollectRemark'
          , 'MainPreference', 'MainUse', 'PreservationFacility', 'GermplasmType', 'SaveQuantity', 'MeasuringUnit', 'SaveUnit', 'SaveVault', 'SavePlace', 'WarehousingYear', 'SaveProperty', 'ResourceDescription', 'ResourceRemark', 'GermplasmImage'
          , 'Certifier', 'CertifyOrg', 'CertifyPlace', 'CertifyYear', 'OperationRange', 'EnterRemark'
          , 'ShareObj', 'ContactInfo', 'ShareMode', 'ShareUse', 'ShareNum', 'ShareBeginTime', 'ShareEndTime']
