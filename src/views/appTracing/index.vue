    ...
    <el-row :gutter="20" style="margin-top:50px;">
      <el-card class="box-card">
        <div slot="header" class="clearfix">
          <p class="tit" align="center">区块链溯源查询结果</p>
        </div>
          ...
          <div class="detail-table" title="收集信息">
            ...
            <div class="detail-row">
              ...
              <div class="detail-value">{{
                  this.collectInfo.collect_place_ecology_type | collectPlaceEcologyFilter
                }}
              </div>
            </div>
            <div class="detail-row">
...
export default {
  ...
  created() {
    this.handleTracing(this.$route.query.Hash)
  ...
  methods: {
    ...
    handleTracing(hash) {
      fetchCertificateByHash(hash).then(response => {
        // console.log(hash)
